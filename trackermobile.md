...
- P-03 Lazy-load heavy screens with React.lazy() + Suspense boundary (expo-router)
...
Provide this backlog to your mobile squad; they can raise tickets with IDs (e.g. M-PERF-01). Prioritise high-risk security/perf first, then UX wow items.