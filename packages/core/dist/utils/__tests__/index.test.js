import { calculateAge, calculateCompatibilityScore, calculateDistance, formatDisplayName, formatPetAge, formatRelativeTime, generateId, isValidEmail } from '../index';
describe('utils', () => {
    ...
    describe('calculateCompatibilityScore', () => {
        ...
        it('should calculate lower compatibility for different species', () => {
            const catPet = { ...mockPet2, species: 'cat' };
