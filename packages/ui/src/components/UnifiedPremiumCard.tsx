...
export function UnifiedPremiumCard({
  children,
  variant = 'default',
  hover = false,
  tilt = false,
  ...
  return (
    <>
      <motion.div
        ...
        animate={{ opacity: disabled ? 0.5 : 1, y: 0, x: 0, scale: 1 }}
        transition={{ ...ANIMATIONS.spring.smooth, delay }}
      ...
      >
        ...
        {glow && isHovered && !disabled && (
          <motion.div
            className="absolute inset-0 pointer-events-none blur-xl scale-110 -z-10"
            style={{
