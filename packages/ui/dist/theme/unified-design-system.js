...
export const utils = {
    ...
    getPlatformStyles: (styles, platform = 'web') => {
        return styles[platform];
    },
    // Create responsive button styles
    createButtonStyles: (variant, size, platform = 'web') => {
    ...
    createInputStyles: (variant, size, platform = 'web') => {
    ...
    shouldEnableButton: (formState) => formState.isValid && formState.isDirty && !(formState.isLoading ?? false),
    // Get theme-aware colors
    getThemeColor: (colorKey, platform = 'web') => {
