...
// === ANIMATION UTILITIES ===
export const createTransition = (property, duration = animations.duration.normal, easing = animations.easing.smooth) => {
    const properties = Array.isArray(property) ? property : [property];
    return properties.map(prop => `${prop} ${duration}ms ${easing}`).join(', ');
};
export const createKeyframes = (name, frames) => {
...
export const withStagger = (animation, index, staggerDelay = animations.stagger.normal) => ({
    ...animation,
