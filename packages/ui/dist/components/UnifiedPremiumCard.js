...
export function UnifiedPremiumCard({ children, variant = 'default', hover = false, tilt = false, glow = false, blur = false, shimmer = false, magnetic = false, padding = 'md', className = '', onClick, entrance = 'fadeInUp', delay = 0, haptic = true, sound = true, disabled = false, 'aria-label': ariaLabel, 'aria-describedby': ariaDescribedBy, 'aria-labelledby': ariaLabelledBy, 'aria-expanded': ariaExpanded, 'aria-selected': ariaSelected, 'aria-hidden': ariaHidden, 'aria-live': ariaLive, 'aria-atomic': ariaAtomic, 'aria-relevant': ariaRelevant, role, tabIndex, 'data-testid': dataTestId, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(motion.div, { ref: cardRef, className: `
        ...
        `, style: {
                ...
                }, initial: entranceAnimation, animate: { opacity: disabled ? 0.5 : 1, y: 0, x: 0, scale: 1 }, transition: { ...ANIMATIONS.spring.smooth, delay }, whileHover: hover && !disabled ? { scale: 1.02, y: -4 } : {}, whileTap: onClick && !disabled ? { scale: 0.98 } : {}, onMouseMove: handleMouseMove, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, onClick: handleClick, onKeyDown: handleKeyDown, "aria-label": ariaLabel, "aria-describedby": ariaDescribedBy, "aria-labelledby": ariaLabelledBy, "aria-expanded": ariaExpanded, "aria-selected": ariaSelected, "aria-hidden": ariaHidden, "aria-live": ariaLive, "aria-atomic": ariaAtomic, "aria-relevant": ariaRelevant, role: role, tabIndex: onClick ? (tabIndex ?? 0) : undefined, "data-testid": dataTestId, "aria-disabled": disabled, children: [glow && isHovered && !disabled && (_jsx(motion.div, { className: "absolute inset-0 pointer-events-none blur-xl scale-110 -z-10", style: {
                            background: `radial-gradient(circle, ${COLORS.primary[400]}20 0%, transparent 70%)`,
                            borderRadius: RADIUS['2xl'],
                        }, initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, transition: ANIMATIONS.spring.micro })), blur && (_jsx(motion.div, { className: "absolute inset-0 pointer-events-none", style: {
                            backdropFilter: BLUR.xl,
                            background: 'rgba(255, 255, 255, 0.05)',
                            borderRadius: RADIUS['2xl'],
                        } })), _jsx("div", { className: "relative z-10", children: children }), hover && isHovered && !disabled && (_jsx(motion.div, { className: "absolute inset-0 pointer-events-none overflow-hidden", initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, style: { borderRadius: RADIUS['2xl'] }, children: _jsx(motion.div, { className: "absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent opacity-20 -skew-x-12", initial: { x: '-100%' }, animate: { x: '100%' }, transition: { duration: 0.6, ease: 'easeInOut' } }) })), shimmer && (_jsx(motion.div, { className: "absolute inset-0 pointer-events-none overflow-hidden", initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { duration: 0.3 }, style: { borderRadius: RADIUS['2xl'] }, children: _jsx(motion.div, { className: "absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent", animate: {
                                x: ['-100%', '100%'],
                            }, transition: {
                                duration: 2,
                                repeat: Infinity,
                                repeatDelay: 3,
                                ease: 'easeInOut',
                            } }) })), magnetic && isHovered && !disabled && (_jsx(motion.div, { className: "absolute inset-0 pointer-events-none", style: {
                            background: 'radial-gradient(circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(255,255,255,0.1) 0%, transparent 50%)',
                            borderRadius: RADIUS['2xl'],
                        }, initial: { opacity: 0 }, animate: { opacity: 1 }, transition: ANIMATIONS.spring.micro }))] }), variant === 'holographic' && (_jsx("style", { children: `
...
//# sourceMappingURL=UnifiedPremiumCard.js.map