...
// === MAIN COMPONENT ===
export const InteractiveButton = ({ title, variant = 'primary', size = 'md', icon, loading = false, disabled = false, magnetic = false, ripple = false, glow = false, shimmer = false, onPress, style, textStyle, testID, }) => {
    // Animation values
    ...
    return (_jsxs(TouchableOpacity, { onPress: handlePress, disabled: disabled || loading, style: [
            styles.button,
            getSizeStyles(),
            {
            ...
            animatedStyle,
            style,
        ], testID: testID, activeOpacity: 0.8, children: [ripple && (_jsx(Animated.View, { style: [
                    styles.ripple,
                    rippleStyle,
                ] })), loading && (_jsx(View, { style: styles.loadingContainer, children: _jsx(ActivityIndicator, { size: "small", color: variantStyles.textColor }) })), _jsx(Animated.View, { style: shimmer && shimmerStyle, children: _jsx(Text, { style: [
                        styles.text,
                        getTextSizeStyles(),
...
//# sourceMappingURL=InteractiveButton.js.map