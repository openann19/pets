...
// Note: 'unique: true' on schema path already creates a unique index for email.
// Avoid duplicate index definitions that cause MONGOOSE warnings in tests.
...
userSchema.pre('save', async function(next) {
  ...
  try {
    // Production: use 12 rounds, Development: use 10 for faster testing
