...
module.exports = function attachWebRTCNamespace(io) {
  ...
  // Middleware for authentication (standardized)
  nsp.use((socket, next) => {
    ...
    try {
      ...
      // Standardized: Use userId (same as chatSocket)
  ...
  nsp.on('connection', (socket) => {
    ...
    socket.on('disconnect', () => {
      console.log(`WebRTC client disconnected: ${socket.id} (User: ${socket.userId})`);
