...
const trackUserEventController = async (req, res) => {
  try {
    ...
    console.error('Error in trackUserEventController:', error);
...
const trackPetEventController = async (req, res) => {
  try {
    ...
    console.error('Error in trackPetEventController:', error);
...
const trackMatchEventController = async (req, res) => {
  try {
    ...
    console.error('Error in trackMatchEventController:', error);
...
const getMatchAnalyticsController = async (req, res) => {
  try {
    ...
    console.error('Error in getMatchAnalyticsController:', error);
