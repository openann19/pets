...
describe('Premium Routes API Test', () => {
  beforeAll(async () => {
    // Ensure Stripe price ID is available in test env
    process.env.STRIPE_PREMIUM_MONTH_PRICE_ID = process.env.STRIPE_PREMIUM_MONTH_PRICE_ID || 'price_test_premium_month';
