...
export const AdvancedInteractionTest: React.FC = () => {
  ...
  const runAllTests = async () => {
    ...
    await runTest('Advanced Button Interactions', async () => {
      ...
      try {
        ...
        console.log('API test completed (expected failure in test)');
      }
    });
    ...
    await runTest('Advanced Card Interactions', async () => {
      ...
      try {
        ...
        console.log('Card API test completed (expected failure in test)');
      }
    });
    ...
    await runTest('Advanced Header Interactions', async () => {
      ...
      try {
        ...
        console.log('Header API test completed (expected failure in test)');
      }
    });
