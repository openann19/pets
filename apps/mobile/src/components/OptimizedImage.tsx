 ...
 */
export const HighPriorityImage: React.FC<Omit<OptimizedImageProps, 'priority'>> = (props) => (
  <OptimizedImage {...props} priority={FastImage.priority.high} />
);
 ...
 */
export const LowPriorityImage: React.FC<Omit<OptimizedImageProps, 'priority'>> = (props) => (
  <OptimizedImage {...props} priority={FastImage.priority.low} />
);
