    ...
    const loadPetDetails = async () => {
      try {
        ...
        const mockPet: PetDetails = {
          ...
          gender: 'male',
          size: 'large',
          description: 'Friendly and energetic Golden Retriever who loves playing fetch and going for walks. Great with kids and other pets.',
          photos: [
            'https://images.unsplash.com/photo-1552053831-71594a27632d?w=400',
            'https://images.unsplash.com/photo-1518717758536-85ae29035b6d?w=400',
          ],
          personalityTags: ['Friendly', 'Energetic', 'Playful', 'Good with kids'],
          healthInfo: {
            vaccinated: true,
            spayedNeutered: true,
            microchipped: true,
