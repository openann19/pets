    ...
    const loadApplication = async () => {
      try {
        ...
        const mockApplication: Application = {
          ...
          applicantExperience: 'I have owned dogs my entire life and currently volunteer at the local animal shelter.',
          homeType: 'Apartment',
          hasChildren: false,
          hasOtherPets: true,
          yardSize: 'Small balcony',
          workSchedule: 'Hybrid - 3 days remote, 2 days office',
          applicationDate: '2024-01-20',
          status: 'pending',
          petName: 'Buddy',
          petPhoto: 'https://images.unsplash.com/photo-1552053831-71594a27632d?w=400',
          notes: 'Sarah seems very experienced with dogs and has a good understanding of pet care requirements.',
          questions: [
            {
              question: 'Why are you interested in adopting this specific pet?',
              answer: 'I love Golden Retrievers and have been looking for a friendly, energetic companion to join my active lifestyle.',
            },
            {
              question: 'How many hours will the pet be alone during the day?',
              answer: 'Maximum 4-5 hours on office days, and I have a dog walker scheduled for those days.',
            },
            {
              question: 'What is your plan for veterinary care?',
              answer: 'I have a great vet nearby and will ensure regular check-ups and vaccinations.',
            },
          ],
        };
