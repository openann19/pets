/**
 * Web API Client
 * Production-hardened API client for Next.js web application
 * Features: Rate limiting, security headers, error handling, retry logic
 */
...
class WebApiClient {
  ...
  private readonly REQUEST_LIMIT = 100; // 100 requests per minute
  private readonly WINDOW_SIZE = 60000; // 1 minute

  constructor(baseURL: string = '') {
    this.baseURL = baseURL !== '' ? baseURL : (typeof window !== 'undefined' ? window.location.origin : '');
  }
