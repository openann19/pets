          ...
          >
            ...
            {!isSuccess ? (
              <>
                ...
                <p className="text-base text-white/70">Enter your new password below.</p>
              </>
            ) : (
              <>
                ...
                <p className="text-base text-white/70">Redirecting you to login...</p>
              </>
            )}
          </motion.div>
          ...
          {!isSuccess ? (
            ...
            >
              <div className="space-y-4 text-center">
                ...
                <p className="text-sm text-white/70">You can now log in with your new password.</p>
              </div>
