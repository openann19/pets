        ...
        >
          ...
          >
            ...
            <h2 className="text-4xl font-extrabold mb-3">
              <span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">Create your account</span>
            </h2>
            <p className="text-base text-white/70">
              Already have an account?{' '}
              <Link href="/login" className="font-semibold text-white hover:text-white/80 transition-colors underline">
                Sign in
              </Link>
            </p>
          </motion.div>
          ...
          >
            <PremiumCard variant="glass" className="p-8 space-y-5">
