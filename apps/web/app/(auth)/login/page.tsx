              ...
              >
                <AnimatePresence>
                  {error && (
                    ...
                    >
                      ...
                      {(error as Error).message || (typeof error === 'string' ? error : 'Login failed')}
                    </motion.div>
                  )}
                </AnimatePresence>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <label
                      htmlFor="remember-me"
                      className="ml-3 block text-sm text-white/80 font-medium cursor-pointer"
                    >
                      Remember me
                    </label>
                  </div>
                  ...
                  <div className="text-sm">
                    <Link
                      ...
                      className="font-semibold text-white/80 hover:text-white transition-colors underline"
                    >
                      Forgot password?
                    </Link>
                  </div>
