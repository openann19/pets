    ...
    <div className="relative min-h-screen text-white">
      ...
      <main className="relative z-40 flex min-h-screen items-center justify-center px-6">
        ...
        >
          ...
          >
            Find Your Pet's
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-300 via-sky-300 to-violet-300">Perfect Match</span>
          </motion.h1>
          ...
          >
            AI-powered compatibility, real-time chat, and ultra-premium experience — now with a cinematic backdrop.
          </motion.p>
          ...
          >
            <Link href="/register" aria-label="Create your profile">
              <motion.div
              ...
              >
                ...
                <PremiumButton variant="primary" glow magneticEffect size="lg" className="text-white relative z-10">
                  Create Your Profile
                </PremiumButton>
              </motion.div>
            </Link>
            <Link href="/browse" aria-label="Start browsing">
              <PremiumButton variant="outline" magneticEffect size="lg" className="text-white">
                Start Browsing
              </PremiumButton>
            </Link>
          </motion.div>
