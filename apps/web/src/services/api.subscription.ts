...
// This helps fix type errors in the Stripe integration tests
export interface SubscriptionApi {
  createCheckoutSession(data: CheckoutSessionRequest): Promise<ApiResponse<CheckoutSessionData>>;
  getCurrentSubscription(): Promise<ApiResponse<{ subscription: SubscriptionData }>>;
  ...
  getPlans(): Promise<ApiResponse<Array<{ id: string; name: string; price: number }>>>;
