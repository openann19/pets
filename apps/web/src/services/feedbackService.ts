...
class FeedbackService {
  ...
  playSound(type: 'success' | 'error' | 'warning' | 'info' = 'info') {
  ...
  provideFeedback(options: FeedbackOptions) {
  ...
  // Success feedback
  success(intensity: 'light' | 'medium' | 'strong' = 'medium') {
    this.provideFeedback({ type: 'success', intensity });
  }

  // Error feedback
  error(intensity: 'light' | 'medium' | 'strong' = 'strong') {
    this.provideFeedback({ type: 'error', intensity });
  }

  // Warning feedback
  warning(intensity: 'light' | 'medium' | 'strong' = 'medium') {
    this.provideFeedback({ type: 'warning', intensity });
  }

  // Info feedback
  info(intensity: 'light' | 'medium' | 'strong' = 'light') {
