...
class OfflineService {
  ...
  async initialize(): Promise<boolean> {
    try {
      ...
      errorHandler.handleError(
        error instanceof Error ? error : new Error('Failed to initialize offline service'),
        {
          component: 'OfflineService',
          action: 'initialize',
          severity: 'high',
   ...
   */
  async cacheData(key: string, data: Record<string, unknown>, expiresIn?: number): Promise<void> {
    try {
      ...
      errorHandler.handleError(
        error instanceof Error ? error : new Error('Failed to cache data'),
        {
          component: 'OfflineService',
          action: 'cache_data',
          severity: 'medium',
   ...
   * Get cached data
   */
  async getCachedData(key: string): Promise<Record<string, unknown> | null> {
    try {
      ...
      errorHandler.handleError(
        error instanceof Error ? error : new Error('Failed to get cached data'),
        {
          component: 'OfflineService',
  ...
  async removeCachedData(key: string): Promise<void> {
    try {
      ...
      errorHandler.handleError(
        error instanceof Error ? error : new Error('Failed to remove cached data'),
        {
          component: 'OfflineService',
  ...
  async queueAction(action: Omit<OfflineAction, 'id' | 'timestamp' | 'retries'>): Promise<string> {
    try {
      ...
      errorHandler.handleError(
        error instanceof Error ? error : new Error('Failed to queue action'),
        {
          component: 'OfflineService',
          action: 'queue_action',
          severity: 'high',
  ...
  async removeAction(id: string): Promise<void> {
    try {
      ...
      errorHandler.handleError(
        error instanceof Error ? error : new Error('Failed to remove action'),
        {
          component: 'OfflineService',
      ...
      for (const action of actionsToSync) {
        try {
          ...
          if (action.retries >= action.maxRetries) {
            ...
            errorHandler.handleError(
              error instanceof Error ? error : new Error('Action failed after max retries'),
              {
                component: 'OfflineService',
  ...
  private async loadPendingActions(): Promise<void> {
    try {
      ...
      errorHandler.handleError(
        error instanceof Error ? error : new Error('Failed to load pending actions'),
        {
          component: 'OfflineService',
          action: 'load_pending_actions',
          severity: 'medium',
  ...
  private async cleanupCache(): Promise<void> {
    try {
      ...
      errorHandler.handleError(
        error instanceof Error ? error : new Error('Failed to cleanup cache'),
        {
          component: 'OfflineService',
   ...
   */
  private async removeEntries(entries: CacheEntry[]): Promise<void> {
    try {
      ...
      errorHandler.handleError(
        error instanceof Error ? error : new Error('Failed to remove entries'),
        {
          component: 'OfflineService',
  ...
  private async saveSyncState(): Promise<void> {
    try {
      ...
      errorHandler.handleError(
        error instanceof Error ? error : new Error('Failed to save sync state'),
        {
          component: 'OfflineService',
