      ...
      <AnimatePresence>
        {state.isPulling && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -50 }}
            className="absolute top-0 left-0 right-0 z-10 flex items-center justify-center bg-gradient-to-b from-pink-500 to-purple-600 text-white"
            style={{ height: state.pullDistance }}
          >
      ...
      <AnimatePresence>
        {state.isRefreshing && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute top-0 left-0 right-0 z-10 flex items-center justify-center bg-gradient-to-b from-pink-500 to-purple-600 text-white h-16"
          >
            <div className="flex items-center space-x-3">
              <motion.div
                animate={{ rotate: 360 }}
...
export function SwipeableCard({
  ...
  return (
    <motion.div
      ...
      drag={false} // Disable framer-motion drag to use custom gesture handling
      animate={{
        x: dragOffset.x,
        y: dragOffset.y,
...
export function PanGesture({
  ...
  const handlePan = (gesture: PanGesture) => {
