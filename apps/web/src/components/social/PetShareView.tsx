...
interface PetShareViewProps {
  pet: Pet
}

export function PetShareView({ pet }: PetShareViewProps) {
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-6">
              ...
              <InteractiveButton
                ...
                className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-400 hover:to-purple-500 text-white font-semibold px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200"
