  ...
  return (
    <div className={className}>
      ...
      <motion.button
        ...
        whileHover={{ scale: 1.05, transition: SPRING_CONFIG }}
        whileTap={{ scale: 0.95, transition: SPRING_CONFIG }}
      >
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {suggestedKeywords.map((keyword) => (
                            <motion.button
                              ...
                              disabled={keywords.includes(keyword) || keywords.length >= 6}
                        ...
                        <div className="flex space-x-2">
                          <input
                            ...
                            className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm disabled:bg-gray-50 disabled:text-gray-400"
                          />
                          <PremiumButton
                            onClick={handleAddCustomKeyword}
                            disabled={!newKeyword.trim() || keywords.length >= 6}
                            variant="secondary"
                            size="sm"
                          >
                            Add
