              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-gradient-to-r from-pink-400 to-purple-500 rounded-full flex items-center justify-center">
                    {currentStory.author.petPhoto ? (
                      <img
                        src={currentStory.author.petPhoto}
                        alt={currentStory.author.petName}
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full flex items-center justify-center">
                    {currentStory.match.petPhoto ? (
                      <img
                        src={currentStory.match.petPhoto}
                        alt={currentStory.match.petName}
                        className="w-12 h-12 rounded-full object-cover"
                      />
                    ) : (
                      <span className="text-white font-semibold text-sm">
...
export function CompactSuccessStories({ 
  className = '',
  maxStories = 3
}: {
  className?: string
