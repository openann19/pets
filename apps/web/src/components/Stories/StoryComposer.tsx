...
export default function StoryComposer({
  ...
  const [selectedFilter, setSelectedFilter] = useState<FilterData>(FILTERS[0]);
  ...
  const addSticker = useCallback((stickerContent: string) => {
            ...
            >
              ...
              <div className="flex flex-col space-y-4 max-w-sm mx-auto">
                ...
                <button
                  ...
                  className="flex items-center justify-center space-x-3 p-6 bg-white/10 backdrop-blur-sm rounded-2xl text-white hover:bg-white/20 transition-colors"
                >
        ...
        <AnimatePresence>
          {showStickers && (
            <motion.div
              ...
              className="absolute bottom-0 left-0 right-0 z-20 p-6 bg-black/90 backdrop-blur-sm"
            >
...
export function useStoryComposer() {
  ...
  const publishStory = async (storyData: StoryData) => {
    try {
      setIsComposing(true);
