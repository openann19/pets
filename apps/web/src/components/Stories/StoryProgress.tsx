 ...
 * 
 * Displays progress bars for multiple stories with smooth animations.
 * Shows current progress and completed/pending states.
 */

import type { Story } from '@pawfectmatch/core';
...
export function StoryProgress({ stories, currentIndex, isPaused }: StoryProgressProps) {
