...
import type { CreateStoryResponse } from '@pawfectmatch/core';
...
export function StoryUploader({ onSuccess, onCancel }: StoryUploaderProps) {
    ...
    const uploadStoryMutation = useMutation({
        mutationFn: async (formData: FormData) => {
            const response = await http.post<CreateStoryResponse>(
                '/api/stories',
                formData,
                {
                    headers: {
                        ...
                        {!selectedFile ? (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="w-full py-16 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl hover:border-purple-500 dark:hover:border-purple-400 transition flex flex-col items-center gap-4 group"
                                >
                            ...
                            >
                                ...
                                <div className="flex gap-3">
                                    <button
                                        onClick={resetForm}
                                        disabled={uploadStoryMutation.isPending}
                                        className="flex-1 py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition font-medium disabled:opacity-50"
                                    >
                                        Change
                                    </button>
                                    <button
                                        ...
                                        disabled={uploadStoryMutation.isPending}
                                        className="flex-1 py-3 px-4 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white rounded-lg hover:from-purple-600 hover:via-pink-600 hover:to-orange-600 transition font-medium disabled:opacity-50 flex items-center justify-center gap-2"
                                    >
