...
// Message Skeleton
export function MessageSkeleton({ count = 3, align = 'left' }: { count?: number; align?: 'left' | 'right' }) {
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {Array.from({ length: count }).map((_, i) => (
        <motion.div
          ...
          transition={{ delay: i * 0.1 }}
          className="bg-white rounded-2xl p-6 space-y-3 shadow-lg border border-gray-100"
        >
          <Skeleton className="h-10 w-10 rounded-lg" />
