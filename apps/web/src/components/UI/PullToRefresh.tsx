          ...
          >
            <div className="flex flex-col items-center space-y-2">
              ...
              {showPawAnimation && (
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: state.canRefresh ? 1 : 0.5 }}
              ...
              {/* Progress indicator */}
              <motion.div
                className="w-32 h-1 bg-neutral-200 dark:bg-neutral-700 rounded-full overflow-hidden"
                style={{ opacity }}
              >
                <motion.div
      ...
      <AnimatePresence>
        {state.isRefreshing && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute top-0 left-0 right-0 z-10 flex items-center justify-center py-4 bg-primary-50 dark:bg-primary-900/20"
          >
