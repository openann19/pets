 ...
 * 
 * The `any` type is intentionally used here to bypass React 19's strict type checking
 * for framer-motion components while filtering undefined values for exactOptionalPropertyTypes
 */
...
export const createDraggableMotionComponent = (
    Component: React.ComponentType<any>,
) => {
    return React.forwardRef<HTMLElement, Record<string, unknown>>((props, ref) => {
