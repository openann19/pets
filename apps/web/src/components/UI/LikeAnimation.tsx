        ...
        <>
          ...
          {particles.map((particle) => (
            <motion.div
              ...
              className="fixed pointer-events-none z-[9999] text-4xl"
              style={{ left: 0, top: 0 }}
            >
              💖
            </motion.div>
          ...
          <motion.div
            ...
            className="fixed top-1/3 left-1/2 -translate-x-1/2 pointer-events-none z-[9999]"
          >
 ...
 */
export function MatchAnimation({ show, onComplete }: LikeAnimationProps) {
  useEffect(() => {
    if (show) {
        ...
        >
          ...
          >
            ...
            <motion.h1
              ...
              className="text-7xl font-black bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent mb-4"
            >
              It's a Match!
            </motion.h1>
            <motion.p
