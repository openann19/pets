...
interface GlassCardProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  hover?: boolean;
  animate?: boolean;
  interactive?: boolean; // 2025 trend: subtle cursor-based effects
}
...
const GlassCardComponent = React.forwardRef<HTMLDivElement, GlassCardProps>(
  ({
    ...
    const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
      if (!interactive || !canHover || reduceMotion || !cardRef.current) return;
    ...
    const interactivePlainStyle: React.CSSProperties | undefined =
    ...
    return (
      <div
        ...
        style={interactivePlainStyle ? { ...(userStyle as React.CSSProperties | undefined), ...interactivePlainStyle } : (userStyle as React.CSSProperties | undefined)}
      ...
      >
        ...
        {glow && (
          <div className="absolute -inset-px bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 rounded-2xl blur-lg opacity-0 group-hover:opacity-60 transition-opacity duration-500 -z-10" />
        )}
