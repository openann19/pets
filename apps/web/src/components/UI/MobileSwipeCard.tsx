  ...
  return (
    <div className={`relative w-full max-w-sm mx-auto ${className}`}>
      <motion.div
        ...
        drag={!disabled}
        dragConstraints={GESTURE_CONFIGS.swipe.dragConstraints}
        dragElastic={GESTURE_CONFIGS.swipe.dragElastic}
      ...
      >
        ...
        {showActions && (
          <div className="flex justify-center gap-3 sm:gap-4 p-4 bg-gray-50">
            ...
            <button
              className="p-3 bg-green-500 text-white rounded-full hover:bg-green-600 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
