...
export const SwipeCardInfo = ({ pet, onCardClick }: SwipeCardInfoProps) => {
  return (
    <motion.div
    ...
    >
      ...
      <motion.button
        onClick={onCardClick}
        className="w-full py-2 text-center text-blue-600 hover:text-blue-800 transition-colors text-sm font-medium"
