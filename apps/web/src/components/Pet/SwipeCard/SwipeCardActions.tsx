...
export const SwipeCardActions = ({
  ...
  const playSound = (type: 'like' | 'pass' | 'superlike') => {
  ...
  const handleAction = (action: 'like' | 'pass' | 'superlike', callback: () => void) => {
  ...
  return (
    <div className="flex justify-center space-x-6 mt-4">
      ...
      <motion.button
        ...
        className="w-16 h-16 bg-red-500 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
      ...
      <motion.button
        ...
        className="w-16 h-16 bg-blue-500 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
        whileHover={{ scale: 1.1, y: -2 }}
        whileTap={{ scale: 0.9 }}
        initial={{ scale: 0, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
      ...
      <motion.button
        ...
        className="w-16 h-16 bg-green-500 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
        whileHover={{ scale: 1.1, y: -2 }}
        whileTap={{ scale: 0.9 }}
        initial={{ scale: 0, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
