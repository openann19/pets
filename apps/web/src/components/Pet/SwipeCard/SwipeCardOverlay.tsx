...
interface SwipeCardOverlayProps {
...
export const SwipeCardOverlay = ({
  ...
  return (
    <>
      {/* Like Overlay */}
      <motion.div
        className="absolute inset-0 bg-gradient-to-br from-green-400 to-green-600 bg-opacity-20 flex items-center justify-center pointer-events-none"
        style={{ opacity: likeOverlayOpacity }}
      >
        <motion.div
          className="text-white text-center"
          style={{ scale: likeIconScale }}
        >
      ...
      {/* Pass Overlay */}
      <motion.div
        className="absolute inset-0 bg-gradient-to-br from-red-400 to-red-600 bg-opacity-20 flex items-center justify-center pointer-events-none"
        style={{ opacity: passOverlayOpacity }}
      >
        <motion.div
          className="text-white text-center"
          style={{ scale: passIconScale }}
        >
      ...
      {/* Super Like Overlay */}
      <motion.div
        className="absolute inset-0 bg-gradient-to-br from-blue-400 to-blue-600 bg-opacity-20 flex items-center justify-center pointer-events-none"
        style={{ opacity: superLikeOverlayOpacity }}
      >
        <motion.div
          className="text-white text-center"
          style={{ scale: superLikeIconScale }}
        >
