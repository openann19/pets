...
const OptimizedSwipeCard = ({
  ...
  */
  ...
  if (isLoading) {
    return (
      <div className="relative w-full h-full bg-neutral-100 dark:bg-neutral-800 rounded-2xl shadow-lg animate-pulse">
  ...
  return (
    <motion.div
      ref={cardRef}
      className="relative w-full h-full bg-white dark:bg-neutral-800 rounded-2xl shadow-xl overflow-hidden"
      style={cardStyle}
      drag
      ...
      role="button"
      aria-label={ariaLabel || `Pet card for ${pet.name}`}
    ...
    >
      ...
      <div className="relative w-full h-full">
        ...
        {/* Premium Badge */}
        {premiumEffects && (
          <div className="absolute top-4 right-4 bg-gradient-to-r from-yellow-400 to-yellow-600 text-white px-3 py-1 rounded-full text-xs font-semibold shadow-lg">
      ...
      {showOverlay && (
        <>
          ...
          <motion.div
            ...
            style={{ opacity: superLikeOverlayOpacity }}
          >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="w-12 h-12 bg-blue-500/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-blue-500 transition-colors"
            ...
            <button
              ...
              className="w-12 h-12 bg-green-500/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-green-500 transition-colors"
...
export const SwipeCard = withErrorBoundary(OptimizedSwipeCard, {
  fallback: (
    <div className="w-full h-full bg-neutral-100 dark:bg-neutral-800 rounded-2xl flex items-center justify-center">
