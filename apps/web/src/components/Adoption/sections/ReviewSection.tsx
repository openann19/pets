...
export const ReviewSection = ({ form, onBack, onSubmit, isSubmitting }: ReviewSectionProps) => {
  const {
    watch,
    formState: { errors },
  } = form;
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          ...
          {formData.livingSituation.yardType && (
            <p>
              <strong>Yard Type:</strong> {formData.livingSituation.yardType}
            </p>
          )}
          {formData.livingSituation.movePlans && (
            <p>
        ...
        <CardContent className="space-y-2">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1 mt-1">
              {formData.petExperience.petPreferences.species.map((species) => (
                <Badge
                  key={species}
                  variant="secondary"
                >
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1 mt-1">
              {formData.petExperience.petPreferences.size.map((size) => (
                <Badge
                  key={size}
                  variant="secondary"
                >
