...
import type { Shelter } from '@pawfectmatch/core';
...
interface ShelterRegistrationProps {
  onSubmit: (data: ShelterFormData) => Promise<void>;
  initialData?: Partial<Shelter>;
}

export const ShelterRegistration = ({ onSubmit, initialData }: ShelterRegistrationProps) => {
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [verificationStep, setVerificationStep] = useState<'basic' | 'documents' | 'review'>(
    'basic',
  );
  ...
  const onFormSubmit = async (data: ShelterFormData) => {
  ...
  if (verificationStep === 'basic') {
    return (
      <Card className="w-full max-w-4xl mx-auto">
        ...
        <CardContent>
          <form
            onSubmit={handleSubmit(() => setVerificationStep('documents'))}
            className="space-y-6"
          >
            {/* Basic Information */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                {errors.contactInfo?.website && (
                  <p className="text-sm text-red-500">{errors.contactInfo.website.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Tell us about your shelter, its mission, and the animals you serve..."
                rows={4}
              />
              {errors.description && (
            ...
            <div className="space-y-2">
              ...
              />
              {errors.capacity?.max && (
                <p className="text-sm text-red-500">{errors.capacity.max.message}</p>
              )}
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {SPECIALIZATION_OPTIONS.map((spec) => (
                  <Badge
                    key={spec}
                    variant={watchedSpecializations.includes(spec) ? 'default' : 'outline'}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="https://facebook.com/happytails"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="https://instagram.com/happytails"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="https://twitter.com/happytails"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-between">
              <Button
                type="button"
                variant="outline"
                onClick={() => setVerificationStep('basic')}
              >
                Back
              </Button>
