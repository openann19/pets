...
interface RescueWorkflowManagerProps {
  applicationId?: string;
}

const RescueWorkflowManager = ({ applicationId: _applicationId }: RescueWorkflowManagerProps): React.JSX.Element => {
  ...
  const calculateProgress = (app: AdoptionApplication) => {
