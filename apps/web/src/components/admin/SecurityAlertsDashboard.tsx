...
import SecurityAlertsDashboardImpl from '../../../components/admin/SecurityAlertsDashboard';
...
export interface Alert {
  ...
  source?: { type: string; name: string; ip?: string | undefined; location?: string | undefined; userAgent?: string | undefined };
  ...
  remediation?: {
    steps: Array<{ id: string; description: string; status: 'pending' | 'in_progress' | 'completed' | 'failed'; assignedTo?: string; dueDate?: string; completedAt?: string }>;
  ...
  acknowledgmentBy?: { id: string; name: string; timestamp: string };
}
...
const SecurityAlertsDashboard = SecurityAlertsDashboardImpl as unknown as (props: SecurityAlertsDashboardProps) => JSX.Element;
