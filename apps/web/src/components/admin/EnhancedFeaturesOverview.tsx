...
interface EnhancedFeaturesOverviewProps {
...
interface OverviewStats {
  biometric: {
    ...
    adoptionRate: number;
    recentRegistrations: BiometricActivity[];
  };
  leaderboard: {
    totalScores: number;
    categories: string[];
    timeframes: string[];
    topScores: LeaderboardActivity[];
  };
  notifications: {
    totalUsers: number;
...
export const EnhancedFeaturesOverview = ({ onNavigate }: EnhancedFeaturesOverviewProps) => {
  ...
  const StatCard = ({
    ...
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className={`bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 cursor-pointer transition-all duration-200 hover:shadow-xl ${onClick ? 'hover:border-pink-300' : ''}`}
      onClick={onClick}
    >
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <StatCard
          ...
          value={stats.leaderboard.totalScores}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              {stats.recentActivity.biometric.slice(0, 5).map((item, index) => (
                <div
                  key={index}
          ...
          <div>
            ...
            <div className="space-y-3">
              {stats.recentActivity.leaderboard.slice(0, 5).map((item, index) => (
                <div
                  key={index}
                  className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg"
                >
          ...
          <div>
            ...
            <div className="space-y-3">
              {stats.recentActivity.notifications.slice(0, 5).map((item, index) => (
                <div
                  key={index}
                  className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg"
                >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button
            onClick={() => onNavigate('biometric')}
            className="flex items-center justify-center space-x-2 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
          >
          ...
          <button
            onClick={() => onNavigate('leaderboard')}
            className="flex items-center justify-center space-x-2 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl hover:bg-yellow-100 dark:hover:bg-yellow-900/30 transition-colors"
          >
          ...
          <button
            onClick={() => onNavigate('notifications')}
            className="flex items-center justify-center space-x-2 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors"
          >
