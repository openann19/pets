...
interface PWAContextType {
  ...
  offlineActions: any[];
  addOfflineAction: (action: any) => string;
...
function PWAStatusIndicator() {
  ...
  return (
    <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50">
      <div className={`px-4 py-2 rounded-full text-white text-sm font-medium shadow-lg flex items-center space-x-2 ${
  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-4 left-4 z-50 bg-orange-500 text-white p-3 rounded-full shadow-lg hover:bg-orange-600 transition-colors"
        aria-label="View offline actions"
      >
                  ...
                  {offlineActions.map((action) => (
                    <div key={action.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <div className="flex items-center space-x-2">
                        <button
                          onClick={() => retryOfflineAction(action.id)}
                          className="px-3 py-1 bg-blue-500 text-white text-xs rounded hover:bg-blue-600 transition-colors"
                          disabled={action.retryCount >= 3}
                        >
                          Retry
                        </button>
                        <button
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-2 mt-3">
              ...
              <button
                ...
                className="px-3 py-1 text-gray-500 text-xs hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
              >
                Not now
              </button>
            </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className={`p-1 rounded ${notificationPermission === 'granted' ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-600'}`}
                  >
