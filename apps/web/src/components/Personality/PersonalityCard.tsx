...
interface PersonalityCardProps {
  ...
  description?: string;
  onPersonalityGenerated?: (personality: PetPersonality) => void;
}
...
export function PersonalityCard({
  ...
  const loadPersonality = async () => {
    try {
      ...
      if (existingPersonality) {
        ...
        const archetypeData = await personalityService.getArchetype(
          existingPersonality.primaryArchetype,
        );
  ...
  const getExistingPersonality = async (_: string): Promise<PetPersonality | null> => {
    return null;
  };
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        ...
        <div className="text-center">
          ...
          <div className="text-xs text-gray-500">
            {personalityService.getIndependenceLevelDescription(
              personality.personalityScore.independence,
            )}
          </div>
        </div>
        <div className="text-center">
          ...
          <div className="text-xs text-gray-500">
            {personalityService.getSociabilityLevelDescription(
              personality.personalityScore.sociability,
            )}
          </div>
        </div>
