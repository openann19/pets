...
export function CompatibilityMatrix({
  ...
  const renderRadarChart = () => {
    if (!pet1.personality || !pet2.personality) return null;
    ...
    return (
      <div className="relative w-64 h-64 mx-auto">
        ...
        >
          ...
          {/* Pet 1 polygon */}
          <polygon
            points={`${100 + (pet1Scores.energy - 5) * 8},${100 - (pet1Scores.sociability - 5) * 8} ${100 + (pet1Scores.independence - 5) * 8},${100 + (pet1Scores.independence - 5) * 8} ${100 - (pet1Scores.energy - 5) * 8},${100 + (pet1Scores.sociability - 5) * 8} ${100 - (pet1Scores.independence - 5) * 8},${100 - (pet1Scores.independence - 5) * 8}`}
          ...
          {/* Pet 2 polygon */}
          <polygon
            points={`${100 + (pet2Scores.energy - 5) * 8},${100 - (pet2Scores.sociability - 5) * 8} ${100 + (pet2Scores.independence - 5) * 8},${100 + (pet2Scores.independence - 5) * 8} ${100 - (pet2Scores.energy - 5) * 8},${100 + (pet2Scores.sociability - 5) * 8} ${100 - (pet2Scores.independence - 5) * 8},${100 - (pet2Scores.independence - 5) * 8}`}
            ...
            {isLoading ? (
              ...
              <>
                ...
                <div className="text-center mb-8">
                  <div
                    className={`inline-flex items-center justify-center w-24 h-24 rounded-full ${getScoreBgColor(compatibility.compatibilityScore)} mb-4`}
                  >
                    <span
                      className={`text-3xl font-bold ${getScoreColor(compatibility.compatibilityScore)}`}
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div
                      className={`text-2xl font-bold ${getScoreColor(compatibility.analysis.energyCompatibility.score)} mb-1`}
                    >
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div
                      className={`text-2xl font-bold ${getScoreColor(compatibility.analysis.socialCompatibility.score)} mb-1`}
                    >
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div
                      className={`text-2xl font-bold ${getScoreColor(compatibility.analysis.independenceCompatibility.score)} mb-1`}
                    >
