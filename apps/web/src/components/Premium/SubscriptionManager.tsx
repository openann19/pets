...
export function SubscriptionManager() {
  ...
  const loadSubscription = async () => {
    try {
      const subscription = await api.subscription.getCurrentSubscription() as Subscription | null;
  ...
  const handleCancelSubscription = async () => {
    ...
    try {
      await api.subscription.cancelSubscription(currentSubscription.id);
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg">
            ...
            <div className="mt-2 h-2 bg-gray-200 rounded-full overflow-hidden">
              <div 
                ...
                style={{ width: `${(usageStats.superLikesUsed / usageStats.superLikesLimit) * 100}%` }}
              />
            </div>
          </div>
