          ...
          <div className="ml-4 flex-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <InteractiveButton
                ...
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-semibold px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-200"
                icon={
                  isLoading ? (
              ...
              {permission === 'granted' && (
                <InteractiveButton
                  ...
                  variant="outline"
                  className="border-blue-300 text-blue-700 hover:bg-blue-50 px-6 py-3 rounded-lg"
...
export function CompactNotificationSetup({ onComplete }: { onComplete?: (enabled: boolean) => void }) {
