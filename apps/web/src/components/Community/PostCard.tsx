...
interface PostCardProps {
  ...
  onReport: (type: 'post' | 'user' | 'comment', id: string, userId?: string) => void;
          ...
          <div className="flex items-center gap-1 border-t pt-3">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="flex-1">
              <Button
                ...
                aria-label={likeSubmitting ? "Liking post..." : "Like this post"}
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="flex-1">
              <Button
                ...
                size="sm"
                onClick={post.authorFollowed ? handleUnfollow : handleFollow}
