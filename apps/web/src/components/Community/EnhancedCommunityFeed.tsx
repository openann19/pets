...
export const EnhancedCommunityFeed: React.FC<EnhancedCommunityFeedProps> = ({ userId }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 p-6">
      ...
      <GlassCard variant="medium" blur="lg" className="p-6">
        <div className="space-y-4">
          <textarea
            ...
            placeholder="Share something amazing with your pack..."
            className="w-full min-h-[120px] bg-transparent border border-white/20 rounded-lg p-4 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-brand-primary resize-none"
          />
      ...
      {/* Empty State */}
      {posts.length === 0 && (
        <GlassCard variant="light" blur="md" className="p-12 text-center">
