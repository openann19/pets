 ...
 */
export const MapErrorBoundary: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <SectionErrorBoundary
    section="Map"
    fallback={
...
export const SwipeErrorBoundary: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <SectionErrorBoundary
    section="Swipe"
    fallback={
      <div className="flex items-center justify-center h-96 bg-gradient-to-br from-pink-50 to-purple-50 rounded-lg">
        <div className="text-center">
