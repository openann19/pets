...
export class AppErrorBoundary extends Component<Props, State> {
  ...
  private handleReload = (): Promise<unknown> => {
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:驾-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                  >
                    Report Error
                  </button>
                </div>
