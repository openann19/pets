      ...
      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-6 pb-8">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center px-8 h-12 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            aria-label="Save"
          >
            {isProcessing ? (
