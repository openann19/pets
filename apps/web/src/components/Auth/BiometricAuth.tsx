...
export const BiometricAuth = ({ onSuccess, onError, onFallback }: BiometricAuthProps) => {
  ...
  return (
    <div className="text-center">
      ...
      <button
        onClick={onFallback}
        className="mt-4 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
      >
