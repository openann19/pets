            ...
            <div className="flex items-center gap-3">
                ...
                <AnimatePresence>
                  {notificationsOpen && (
                    <motion.div
                      ...
                      className="absolute right-0 mt-2 w-80 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 shadow-2xl overflow-hidden"
                    >
              ...
              <div ref={profileMenuRef} className="relative">
                <motion.button
                  ...
                  className="flex items-center gap-2 p-1.5 rounded-xl bg-white/10 hover:bg-white/20 transition-all"
                      ...
                      <div className="p-2">
                        <Link href="/profile">
                          <button
                            ...
                            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/10 text-white transition-all"
                          >
