        ...
        <AnimatePresence>
          {showMenu && (
            <motion.div
              ...
              className="absolute top-full right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-4 z-50"
            >
                ...
                {Object.entries(tours).map(([tourId, tour]) => (
                  ...
                  >
                    ...
                    <InteractiveButton
                      ...
                      size="sm"
                      className="ml-3 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-400 hover:to-purple-500 text-white"
              ...
              <div className="text-center">
                ...
                <div className="flex space-x-3">
                  <InteractiveButton
                    ...
                    className="flex-1 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-400 hover:to-purple-500 text-white"
...
export function CompactTourLauncher({ 
  tourId, 
  className = '' 
}: { 
  tourId: string
...
export function FloatingHelpButton({ className = '' }: { className?: string }) {
  ...
  return (
    <div className={`fixed bottom-6 left-6 z-40 ${className}`}>
      <InteractiveButton
        onClick={() => setShowMenu(!showMenu)}
        className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-400 hover:to-purple-500 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-200"
      ...
      <AnimatePresence>
        {showMenu && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0, scale: 1 }}
            exit={{ opacity: 0, y: -10, scale: 0.95 }}
            className="absolute bottom-full left-0 mb-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-4"
          >
