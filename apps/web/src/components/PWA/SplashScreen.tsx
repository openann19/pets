  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-primary-500 via-secondary-500 to-purple-600 ${className}`}
      >
        {/* Background Pattern */}
...
export function IOSSplashScreen({ onComplete }: { onComplete: () => void }) {
  return (
    <SplashScreen
...
export function AndroidSplashScreen({ onComplete }: { onComplete: () => void }) {
  return (
    <SplashScreen
      onComplete={onComplete}
      className="bg-gradient-to-br from-green-500 via-blue-500 to-purple-500"
    />
  )
}

// Desktop splash screen
export function DesktopSplashScreen({ onComplete }: { onComplete: () => void }) {
  return (
    <SplashScreen
      onComplete={onComplete}
