...
export const ProfileVerification = ({ onComplete }: ProfileVerificationProps) => {
    ...
    try {
      ...
      if (result.success) {
        const newDoc: VerificationDocument = {
          ...
          type: type as "id_front" | "id_back" | "pet_photo" | "vet_certificate" | "adoption_papers" | "rescue_document",
          url: result.url,
          uploadedAt: new Date(),
        };
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={petInfo.microchipNumber}
                  onChange={(e) =>
                    setPetInfo((prev) => ({ ...prev, microchipNumber: e.target.value }))
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setPetInfo((prev) => ({ ...prev, vetAddress: e.target.value }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                />
              </div>
            </div>
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="ml-3">
                  <p
                    className={`text-sm font-medium ${isActive ? 'text-pink-600' : isCompleted ? 'text-green-600' : 'text-gray-500'
                      }`}
                  >
                    {step.title}
                  </p>
