        ...
        <div className="flex items-center justify-center space-x-4">
          {isRecording ? (
            <button
              ...
              className="flex items-center justify-center w-16 h-16 bg-red-500 hover:bg-red-600 rounded-full transition-colors"
            ...
            <>
              <button
                onClick={handleCancel}
                className="flex items-center justify-center w-14 h-14 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-full transition-colors"
                aria-label="Delete"
              >
              ...
              <button
                onClick={handleSend}
                className="flex items-center justify-center w-16 h-16 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 rounded-full transition-all shadow-lg"
                aria-label="Send"
              >
