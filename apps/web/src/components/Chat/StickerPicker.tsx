    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-md max-h-[80vh] flex flex-col"
              ...
              <div className="grid grid-cols-4 gap-3">
                {currentPack.stickers.map((sticker) => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-12 h-12 text-2xl flex items-center justify-center bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
