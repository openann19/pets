...
export const FileShare = ({ onFileSelect, onClose }: FileShareProps) => {
        ...
        {fileTypes.map((fileType) => {
          ...
          return (
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => openFileDialog(fileType.accept)}
              className="w-full flex items-center p-3 rounded-lg bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
            >
