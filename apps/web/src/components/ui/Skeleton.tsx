...
export const SkeletonBase = (props: any) => (
  <ContentLoader
    ...
    className="dark:bg-neutral-700 dark:foreground-neutral-600"
    {...props}
  >
    {props.children}
  </ContentLoader>
...
export const SkeletonMessage = (props: any) => (
  <motion.div
...
// Avatar Skeleton
export const SkeletonAvatar = ({ size = 40, ...props }: { size?: number } & any) => (
  <ContentLoader
    speed={2}
    width={size}
    height={size}
    backgroundColor="#d1d5db"
    foregroundColor="#eceff1"
    className="dark:bg-neutral-700 dark:foreground-neutral-600 rounded-full"
    {...props}
  >
...
export const SkeletonButton = ({ 
  ...
  <ContentLoader
    ...
    backgroundColor="#d1d5db"
    foregroundColor="#eceff1"
    className="dark:bg-neutral-700 dark:foreground-neutral-600 rounded-lg"
    {...props}
  >
...
// Profile Skeleton
export const SkeletonProfile = (props: any) => (
  <motion.div
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
    transition={{ duration: 0.3 }}
...
export const Shimmer = ({ className = '', ...props }: { className?: string } & any) => (
  <div
    className={`animate-pulse bg-gradient-to-r from-neutral-200 via-neutral-300 to-neutral-200 dark:from-neutral-700 dark:via-neutral-600 dark:to-neutral-700 bg-[length:200%_100%] animate-shimmer ${className}`}
    {...props}
  />
)
