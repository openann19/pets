...
interface EmptyStateProps {
  type: 'discover' | 'chat' | 'notifications' | 'matches' | 'pets' | 'custom'
  title: string
  description: string
  action?: {
    label: string
  ...
  chat: (
    <div className="relative">
      ...
      <motion.div
        ...
        className="absolute -bottom-1 -left-1 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center"
      >
...
export function DiscoverEmptyState({ 
  ...
  scenario?: keyof typeof contextualMessages.discover
  onRefresh?: () => void
  onStartSwiping?: () => void
  ...
  return (
    <EmptyState
      ...
      action={actionMap[scenario]}
    />
  )
}

export function ChatEmptyState({
  scenario = 'noConversations',
  onStartSwiping,
  onSendMessage,
}: {
  scenario?: keyof typeof contextualMessages.chat
  onStartSwiping?: () => void
  onSendMessage?: () => void
}) {
    ...
    >
      ...
      <div className="mb-8">
        <motion.div
          animate={{ opacity: [0.5, 1, 0.5] }}
          transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut' }}
          className="w-24 h-24 mx-auto rounded-full bg-neutral-200 dark:bg-neutral-700"
        />
      </div>
      ...
      <div className="space-y-4 w-full">
        <motion.div
          ...
          className="h-6 bg-neutral-200 dark:bg-neutral-700 rounded-lg mx-auto w-3/4"
        />
        <motion.div
          animate={{ opacity: [0.5, 1, 0.5] }}
          transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: 0.4 }}
          className="h-4 bg-neutral-200 dark:bg-neutral-700 rounded-lg mx-auto w-full"
        />
        <motion.div
          animate={{ opacity: [0.5, 1, 0.5] }}
          transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: 0.6 }}
          className="h-4 bg-neutral-200 dark:bg-neutral-700 rounded-lg mx-auto w-2/3"
        />
      </div>
      ...
      <motion.div
        ...
        className="mt-8 h-10 bg-neutral-200 dark:bg-neutral-700 rounded-lg w-full"
      />
    </motion.div>
  )
}
