...
export const BiometricManagement = ({ onBack }: BiometricManagementProps) => {
  ...
  const handleRemoveCredential = async (userId: string) => {
              ...
              {data?.credentials.map((credential) => (
                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-pink-100 dark:bg-pink-900 rounded-full flex items-center justify-center">
                        {credential.userId.avatar ? (
                          <img
                            src={credential.userId.avatar}
                            alt=""
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <button
                      onClick={() => handleRemoveCredential(credential.userId._id)}
