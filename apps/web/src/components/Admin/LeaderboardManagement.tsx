...
interface LeaderboardData {
  topPerformers: LeaderboardScore[];
  categoryStats: {
    _id: string;
    count: number;
    avgScore: number;
...
export const LeaderboardManagement = ({ onBack }: LeaderboardManagementProps) => {
          ...
          <div className="space-y-4">
            {data?.topPerformers.map((performer, index) => (
              ...
              >
                <div className="flex items-center space-x-4">
                  <div
                    className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold ${getRankColor(performer.rank)}`}
                  >
