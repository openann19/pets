import ReportsManagementImpl from '../../../components/admin/ReportsManagement';
...
interface Report {
  ...
  isPublic: boolean;
  tags: string[];
  recipients: Array<{ id: string; name: string; email: string; type: 'email' | 'webhook' | 'ftp' }>;
  schedule?: { frequency: 'once' | 'daily' | 'weekly' | 'monthly'; time: string; timezone: string; enabled: boolean };
}
...
const ReportsManagement = ReportsManagementImpl as unknown as (props: ReportsManagementProps) => React.ReactElement;
