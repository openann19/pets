...
export default function APIManagement() {
  ...
  const handleEndpointAction = (action: string, endpointId: string, data?: any) => {
    console.log(`${action} endpoint ${endpointId}`, data);
  };
        ...
        <PremiumCard className="p-6 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {stats && Object.entries(stats.performanceMetrics).map(([metric, value], index) => (
                <motion.div 
                  key={metric}
                  className="text-center p-4 bg-gradient-to-br from-gray-50 to-white rounded-lg border border-gray-100"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      ...
                      <td className="py-4 px-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <motion.button
                            onClick={() => handleEndpointAction('test', endpoint.id)}
                          ...
                          <motion.button
                            onClick={() => handleEndpointAction('edit', endpoint.id)}
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center space-x-4">
              <PremiumButton
                ...
                icon={isRunningTests ? <ArrowPathIcon className="w-5 h-5 animate-spin" /> : <PlayIcon className="w-5 h-5" />}
                className="px-6 py-3"
              >
