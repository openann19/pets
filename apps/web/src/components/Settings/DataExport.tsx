        ...
        <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                    <div className="flex items-start space-x-4">
                        ...
                        {exportStatus.status === 'processing' && (
                            <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-primary-600 flex-shrink-0" />
                        )}
            ...
            {!exportStatus || exportStatus.status === 'completed' || exportStatus.status === 'failed' ? (
                <button
                    ...
                    disabled={isRequesting || !Object.values(includeOptions).some((v) => v)}
