    ...
    <>
      ...
      >
        <button
          ...
          className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-400 hover:to-purple-500 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 group"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg resize-none focus:ring-2 focus:ring-pink-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                        rows={4}
                        required
                      />
                    </div>
                    ...
                    <InteractiveButton
                      ...
                      className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-400 hover:to-purple-500 text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200"
                      icon={
                        isSubmitting ? (
...
export function CompactFeedbackButton({ 
  type = 'general',
  className = ''
}: { 
  type?: 'bug' | 'feature' | 'general' | 'love'
