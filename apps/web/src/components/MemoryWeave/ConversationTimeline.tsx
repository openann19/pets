...
export const ConversationTimeline = ({
  ...
  const generatePhases = (): RelationshipPhase[] => {
    ...
    if (!devStartMessage || !devEndMessage) return phases;
    ...
    if (!deepStart || !deepEnd) return phases;
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-purple-50">
        <CardContent className="p-6">
          <div className="text-center space-y-4">
            ...
            <Progress
              value={((phases.findIndex((p) => p.id === 'current') + 1) / phases.length) * 100}
              className="mt-4"
            />
