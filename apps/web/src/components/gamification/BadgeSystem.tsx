...
export function BadgeSystem({ 
  ...
  return (
    <div className={`bg-white rounded-xl p-6 shadow-lg ${className}`}>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                  <div 
                    ...
                    style={{ width: `${getLevelProgress(gamification.totalPoints).percentage}%` }}
                  />
                </div>
              </div>
            )}
      ...
      {/* Streaks */}
      {showStreaks && gamification?.streaks && gamification.streaks.length > 0 && (
        <div className="mb-6">
        ...
        {newBadges.length > 0 && (
          ...
          >
            <div className="bg-white rounded-lg shadow-2xl border border-gray-200 p-4 max-w-sm">
              ...
              {newBadges.map((badge) => (
                <div key={badge.id} className="flex items-center space-x-3 mb-2">
...
// Badge Details Modal
function BadgeDetailsModal({ badge, onClose }: { badge: Badge; onClose: () => void }) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      >
        <div className="text-center">
          ...
          <InteractiveButton
            onClick={onClose}
            className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-400 hover:to-purple-500 text-white"
          >
            Got it!
          </InteractiveButton>
        </div>
