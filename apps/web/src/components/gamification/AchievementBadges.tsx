...
interface Achievement {
  ...
  title: string;
  description: string;
  icon: 'heart' | 'chat' | 'star' | 'fire' | 'trophy' | 'sparkles';
  unlocked: boolean;
  progress?: number;
  maxProgress?: number;
  unlockedAt?: Date;
...
export const AchievementBadges = ({ achievements, onBadgeClick }: AchievementBadgesProps) => {
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <svg className="w-full h-full -rotate-90">
                      ...
                      <circle
                        ...
                        strokeDashoffset={`${
                          2 * Math.PI * 45 * (1 - achievement.progress / achievement.maxProgress)
                        }`}
          ...
          {achievements
            ...
            .map((achievement) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-lg bg-gradient-to-br ${rarityColor} flex items-center justify-center flex-shrink-0`}
                  >
