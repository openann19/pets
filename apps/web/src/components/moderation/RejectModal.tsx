    ...
    <AnimatePresence>
      {isOpen && (
        ...
        <div className="flex-1 overflow-y-auto p-6">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  <motion.span
                    ...
                    animate={selectedCategory === template.category ? { scale: [1, 1.2, 1] } : {}}
          ...
          {/* Custom Reason Input */}
          {selectedCategory && useCustomReason && (
            <motion.div
          ...
          {selectedCategory && (
            <motion.div
              ...
              className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 border-2 border-gray-200 shadow-inner"
            >
        ...
        <div className="px-6 py-4 border-t border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100 flex items-center justify-between gap-3">
          ...
          <motion.button
            ...
            whileHover={{ scale: selectedCategory ? 1.05 : 1 }}
            whileTap={{ scale: selectedCategory ? 0.95 : 1 }}
            className="px-6 py-2.5 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg font-medium hover:from-red-700 hover:to-red-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg disabled:shadow-none"
          >
            Confirm Rejection
          </motion.button>
        </div>
