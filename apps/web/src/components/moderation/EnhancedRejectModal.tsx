...
export default function EnhancedRejectModal({ isOpen, onClose, onConfirm }: EnhancedRejectModalProps) {
            ...
            <GlassCard variant="heavy" blur="xl" className="overflow-hidden">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {REJECTION_TEMPLATES.map((template) => (
                          <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className={`p-4 rounded-xl border-2 border-white/10 text-left transition-all ${template.bgColor} hover:border-white/30`}
                          >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={5}
                          className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-brand-primary resize-none"
              ...
              <div className="px-6 py-4 border-t border-white/10 bg-white/5 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  {step === 'customize' && (
                    <AnimatedButton variant="ghost" onClick={() => setStep('select')}>
                      Back
                    </AnimatedButton>
                  )}
                  {step === 'customize' && (
