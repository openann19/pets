...
export interface AirQualityMetric {
  score: number;
  pollutants: { [key: string]: number };
  recommendations: string[];
}

// Seismic & Natural Disaster Types
