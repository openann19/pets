...
export default function SwipeV2Page() {
  ...
  const handleSwipe = (action: 'like' | 'pass' | 'superlike', petId: string) => {
  ...
  const handleCardClick = useCallback(() => {
    ...
    console.log('Card clicked:', currentPet.name);
  }, [currentPet]);
