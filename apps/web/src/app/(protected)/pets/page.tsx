      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            className="px-4 py-2 bg-pink-600 hover:bg-pink-700 text-white font-medium rounded-lg flex items-center transition-colors"
          >
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {pets.map((pet) => (
              <div
                key={pet.id}
                className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden group hover:shadow-xl transition-shadow"
              >
                <Link
                  href={`/pets/${pet.id}`}
                  className="block"
                >
                  <div className="p-6 flex items-center space-x-4">
                    ...
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity">
                      <Link
                        href={`/pets/${pet.id}`}
                        className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-pink-100 dark:hover:bg-pink-900/30 flex items-center justify-center text-gray-500 hover:text-pink-600 dark:text-gray-400 dark:hover:text-pink-400 transition-colors"
                      >
              ...
              <form onSubmit={handleAddPet}>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['dog', 'cat', 'bird', 'rabbit', 'fish', 'reptile', 'other'].map((species) => (
                      <button
                        key={species}
                        type="button"
                        ...
                        onClick={() => setNewPetSpecies(species as Pet['species'])}
                      >
                        <div className="text-2xl mb-1">
                          {getSpeciesEmoji(species as Pet['species'])}
                        </div>
