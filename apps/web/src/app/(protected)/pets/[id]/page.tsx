...
export default function PetProfilePage() {
  ...
  const [pet, setPet] = useState<Partial<PetProfile> | null>(null);
  ...
  const fetchPet = async () => {
    ...
    try {
      ...
      // Sample pet data
      const mockPet: Partial<PetProfile> = {
        id: id as string,
        name: 'Buddy',
        species: 'dog',
        ...
        color: 'Golden',
        description:
          "Buddy is a friendly, energetic dog who loves to play fetch and go on long walks. He's great with kids and other pets.",
  ...
  const handleSave = async (updatedPet: Partial<PetProfile>) => {
    setIsSaving(true);
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6">
          <PersonalityCard
            ...
            breed={pet?.breed}
            age={pet?.age}
            personalityTags={pet?.personality}
