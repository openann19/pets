...
export default function MapPage() {
  ...
  const fetchPlaygrounds = async () => {
    ...
    try {
      ...
      const mockPlaygrounds: PetPlayground[] = [
        {
          id: 'playground1',
          name: 'Central Park Dog Run',
          description:
            'A spacious off-leash dog park with separate areas for small and large dogs, water fountains, and plenty of shade.',
        ...
        },
        {
          ...
          description:
            'Upscale pet resort with indoor and outdoor play areas, grooming services, and boarding facilities.',
        ...
        },
        {
          ...
          description:
            'Pet-friendly cafe where you can enjoy coffee with your furry friend. Offers special treats for pets and a relaxing atmosphere.',
        ...
        },
        {
          ...
          description:
            'A section of beach where dogs are allowed to swim and play off-leash during designated hours.',
        ...
        },
        {
          ...
          name: 'PetSmart',
          description:
            'Large pet supply store with grooming services and occasional pet adoption events.',
        ...
        },
        {
          ...
          description:
            'Full-service veterinary hospital offering emergency care, specialty services, and routine checkups.',
  ...
  const handlePlaygroundSelect = (playground: PetPlayground) => {
  ...
  const handleToggleFavorite = (playground: PetPlayground) => {
            ...
            {playgrounds.slice(0, 6).map((playground) => (
              ...
              >
                ...
                <div className="h-48 bg-gray-200 dark:bg-gray-700 relative">
                  ...
                  >
                    <HeartIcon
                      className={`w-5 h-5 ${playground.isFavorite
                  ...
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <StarIcon
                          key={star}
                          className={`w-4 h-4 ${star <= playground.rating
                    ...
                    <span
                      className={`text-xs ${isOpenNow(playground) === 'Open'
      ...
      {showModal && selectedPlayground ? <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="h-64 bg-gray-200 dark:bg-gray-700 relative">
            ...
            >
              <HeartIcon
                className={`w-5 h-5 ${selectedPlayground.isFavorite
                    ? 'text-pink-500 fill-pink-500'
                    : 'text-gray-400 dark:text-gray-500'
                  }`}
              />
            ...
            <div className="flex items-center space-x-2 mb-2">
              ...
              <div className="flex items-center">
                {[1, 2, 3, 4, 5].map((star) => (
                  <StarIcon
                    key={star}
                    className={`w-4 h-4 ${star <= selectedPlayground.rating
                        ? 'text-yellow-500 fill-yellow-500'
                        : 'text-gray-300 dark:text-gray-600'
                      }`}
                  />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <div
                    className={`text-xs font-medium ${isOpenNow(selectedPlayground) === 'Open'
                        ? 'text-green-600 dark:text-green-400'
              ...
              {selectedPlayground.phone ? <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <a
                    href={`tel:${selectedPlayground.phone}`}
              ...
              {selectedPlayground.website ? <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <a
                    href={selectedPlayground.website}
                    target="_blank"
            ...
            <div className="flex space-x-2">
              <button
                onClick={() => {
                  ...
                  window.open(
                    `https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(selectedPlayground.address)}`,
                    '_blank',
                  );
                }}
