...
import type { PrivacySettings } from '@/components/Privacy/PrivacyControls';
...
interface LegacyPrivacySettings {
...
export default function SettingsPage() {
  ...
  function sanitizePrivacySettings(settings: LegacyPrivacySettings): PrivacySettings {
    return {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <PrivacyControls
              settings={sanitizePrivacySettings(user.privacySettings || {})}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                ...
                <a
                  ...
                  className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-200 shadow-lg hover:shadow-xl"
                >
