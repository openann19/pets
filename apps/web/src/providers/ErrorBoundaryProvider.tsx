  ...
  return (
    <ErrorContext.Provider value={contextValue}>
        ...
        fallback={
          <div className="min-h-screen bg-gradient-to-br from-red-50 to-red-100 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
              ...
              {process.env.NODE_ENV === 'development' && globalError && (
      ...
      >
        <AsyncErrorBoundary
          fallback={
            <div className="border border-orange-200 bg-orange-50 rounded-lg p-4 m-4">
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => window.location.reload()}
                  className="ml-auto text-sm bg-orange-600 text-white px-2 py-1 rounded hover:bg-orange-700 transition-colors"
                >
                  Refresh
                </button>
              </div>
