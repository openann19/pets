...
function useActions() {
  ...
  return [
    ...
    // Account actions
    {
      ...
      perform: () => {
        // Handle logout logic
        console.log('Logout triggered from command palette')
      ...
      <KBarPortal>
        <KBarPositioner className="z-[200] bg-black/50 backdrop-blur-sm">
          <KBarAnimator className="bg-white dark:bg-neutral-800 w-[600px] max-w-full rounded-xl shadow-2xl overflow-hidden border border-neutral-200 dark:border-neutral-700">
            <KBarSearch 
              className="w-full p-4 bg-neutral-50 dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-700 outline-none text-neutral-900 dark:text-neutral-100 placeholder-neutral-500 dark:placeholder-neutral-400"
