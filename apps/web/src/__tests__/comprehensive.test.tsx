...
import { } from '../components/AI/CompatibilityAnalyzer';
import { } from '../components/AI/PhotoAnalyzer';
...
import { _createMockPet } from './test-helpers';

// Mock data
const mockPet = _createMockPet({
  _id: '1',
  name: 'Max',
