...
export const getCSSVar = (varName: string) => `var(--${varName})`;
export const getColorVar = (color: string) => `var(--color-${color})`;
export const getSpacingVar = (size: string) => `var(--space-${size})`;
export const getRadiusVar = (size: string) => `var(--radius-${size})`;
export const getDurationVar = (duration: string) => `var(--duration-${duration})`;
export const getEaseVar = (ease: string) => `var(--ease-${ease})`;
