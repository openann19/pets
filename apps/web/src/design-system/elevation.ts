...
export const getElevation = (level: keyof typeof ELEVATION.levels) => {
  return ELEVATION.levels[level];
};

export const getPremiumElevation = (color: keyof typeof ELEVATION.premium) => {
  return ELEVATION.premium[color];
};

export const getGlassElevation = (size: keyof typeof ELEVATION.glass) => {
  return ELEVATION.glass[size];
};

export const getNeonElevation = (intensity: keyof typeof ELEVATION.neon) => {
  return ELEVATION.neon[intensity];
};

export const getInteractiveElevation = (effect: keyof typeof ELEVATION.interactive) => {
