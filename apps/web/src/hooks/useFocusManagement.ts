 ...
 */
export function useRestoreFocus(triggerRef?: React.RefObject<HTMLElement>) {
    useEffect(() => {
        const previouslyFocused = document.activeElement as HTMLElement;
 ...
 */
export function useFocusOrder<T extends HTMLElement>(containerRef: React.RefObject<T>) {
