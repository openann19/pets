...
export function useAdminPermissions() {
  ...
  const hasAnyPermission = useCallback(
    (permissionList: string[]): boolean => permissionList.some((permission) => hasPermission(permission)),
    [hasPermission],
  );
  ...
  const hasAllPermissions = useCallback(
    (permissionList: string[]): boolean => permissionList.every((permission) => hasPermission(permission)),
    [hasPermission],
  );
...
export const RoleGuard = ({ role, fallback = null, children }: RoleGuardProps) => {
