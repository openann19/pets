...
// Define strict type for image formats
...
class ImageCacheManager {
   ...
   * Get cached image
   */
  static get(key: string): CachedImage | null {
...
export function useLazyImage(
  ...
  useEffect(() => {
    if (!isIntersecting && options.lazy) return;
...
>(({ src, alt, options = {}, className = '', style, onLoad, onError }, ref): React.ReactElement => {
