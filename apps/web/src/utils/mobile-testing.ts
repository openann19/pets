...
export function useMobileTesting() {
  const [results, setResults] = useState<MobileTestResults | null>(null);
 ...
 */
async function testTouchTargets(): Promise<TouchTargetTest[]> {
 ...
 */
async function testResponsiveDesign(): Promise<ResponsiveTest[]> {
 ...
 */
async function testPerformance(): Promise<PerformanceTest[]> {
 ...
 */
async function testAccessibility(): Promise<AccessibilityTest[]> {
 ...
 */
async function testSafeAreas(): Promise<SafeAreaTest[]> {
  const results: SafeAreaTest[] = [];
 ...
 */
function calculateOverallScore(results: MobileTestResults): number {
  let score = 0;
  let totalWeight = 0;
 ...
 */
function generateRecommendations(results: MobileTestResults): string[] {
 ...
 */
export function quickMobileHealthCheck(): Promise<{ score: number; issues: string[] }> {
