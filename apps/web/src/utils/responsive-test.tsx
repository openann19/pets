...
export function ResponsiveTest() {
  return (
    <div className="fixed top-4 right-4 z-50 bg-black/80 text-white p-4 rounded-lg text-sm backdrop-blur-md border border-white/20">
...
export function ButtonResponsiveTest() {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-100 dark:bg-gray-800 rounded-xl">
