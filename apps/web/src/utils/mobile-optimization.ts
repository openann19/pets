...
export const optimizeImageForMobile = (src: string, width: number, height: number) => {
...
export const useNetworkAwareLoading = () => {
  ...
  const [loadingStrategy, setLoadingStrategy] = useState<'aggressive' | 'conservative' | 'minimal'>('aggressive');
