 ...
 */
export async function convertToWebP(imageBlob: Blob, quality: number = 0.8): Promise<Blob> {
  return await new Promise((resolve, reject) => {
    const img = new Image();
 ...
 * Compress image
 */
export async function compressImage(imageBlob: Blob, maxSizeMB: number = 1): Promise<Blob> {
