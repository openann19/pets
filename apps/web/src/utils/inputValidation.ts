...
export class ValidationEngine {
   ...
   */
  private static sanitizeByType(value: unknown, type: string, sanitize?: boolean): unknown {
...
export function createValidationMiddleware(schema: ValidationSchema) {
  return (req: Request, res: Response, next: NextFunction) => {
    const result = ValidationEngine.validate(req.body as Record<string, unknown>, schema);
